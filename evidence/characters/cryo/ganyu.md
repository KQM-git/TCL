...
[[video] ARCC tech test](https://youtu.be/0QUL-yOl_CY)<span style="text-decoration:underline;"> </span> 
...
(1+((.748+.08)*(1.809+.15)))/(1+(.748*1.809)) = 1.114 => 11.4% multiplicative increase

2 cards:

(1+((.748+.16)*(1.809+.3)))/(1+(.748*1.809)) = 1.239 => 23.9% multiplicative increase +40% Atk, -15% def chamber card: 
