...
### Poise Damage from Character Attacks and Talents

The major test object is level 88 Cryogunner, whose poise value is 2. Numbers with asterisks indicate that the attack can interrupt Normal Standing and Spraying Frost of the Cryogunner Legionnaire.

**Notes**

* Poise Damage is also affected by the Character Level.
* For Sword and Polearm characters, the Poise Damage of charged attack includes N1

| Character \(level\) | Normal Attack | Heavy Attack | Skill | Burst |
| :--- | :--- | :--- | :--- | :--- |
| Albedo \(50/60\) | 1.5\* | 1.25\* | 0.25\* / \(Explosion\) 0.5 | More Than 2\* |
| Amber \(50/60\) | 0 | \(Body\) 0 / \(Weakpoint\) 0.5 | 1.25\* | 0.5 |
| Barbara \(70\) | 0 | 0 | 0.5\* | 0 |
| Beidou \(50/60\) | 0.75 / 0.75 / 0.75 / 1 / 1.25\* | 0.5 / 1\* | 0.75 / \(Counterattack\) 3\* | 5\* |
| Bennett \(80\) | 1.75\* | 1.25\* | 0.75 / 1.75 / 4.75\* | 1.75\* |
| Chongyun \(50/60\) | 0.75 / 0.75 / 0.75 / More Than 1.25\* | 0.5 / 1\* | 1.25\* | More Than 2\* |
| Diluc \(80\) | 1 / 1 / 1 / 1.5\* | 0.5 / 1\* | 1.25\* | More Than 6.75\* |
| Diona \(70\) | 0 | \(Body\) 0 / \(Weakpoint\) 0.5\* | 0.25 / 0.75 | 0.25 / \(DoT\) 0.25 |
| Fischl \(80\) | 0 | \(Body\) 0 / \(Weakpoint\) 0.5\* | 0.75 / \(Oz\) 0 | 1.5 |
| Ganyu \(60\) | 0 | \(Body\) 0 / \(Weakpoint\) 0.5 _/ \(Frostflake to Body\) 0.25 / \(Frostflake to  Weakpoint\) 0.75_ / \(Frostflake Bloom\) 0 | 0.5 / 0.75\* | 0.5 |
| Jean \(70 with C1\) | 1.75\* | 2\* | 1.25 / More Than 2\* | More Than 2\* / \(DoT\) 0.25 |
| Kaeya \(50/60\) | 1.75\* | 0.75\* | 1.25\* | More Than 2\* |
| Keqing \(60\) | More Than 2\* | 1.25\* | 0.5 / \(Slashing\) 1.25\* / \(Thundering\) 0.25 | More Than 2\* |
| Klee \(81/90\) | \(1st Normal Attack\) 0.5 / \(All Normal Attack\) More Than 2\* | 1.25\* | \(Big bomb\) 0.5 / \(S mall Bombs\) 0.25 \|\| \(4 hits\) 1.25 |  |
| Lisa \(50/60\) | 0 | 0 | 0 / 1.25\* | 1\* |
| Mona \(80/90\) | 0 | 0 | \(All Hits\) More Than 1.5 | \(Bubble Explosion\) 0.25 |
| Ningguang \(80\) | 0.75 \(2 Hits\) | 0.25 / \(Star Jades\) 0.25\* | 1.25\* | 1.5 / \(Jade Screen\) 1\* |
| Noelle \(70\) | 1 / 1 / 1 / 1.25\* | 0.5 / 1\* | 1 | 3 _/ 1.5 / 1.75_ |
| Qiqi \(80\) | 1.25\* | 1.25\* | 0.25 / \(Ice globle\) 0.75\* | 1.75\* |
| Razor \(80\) | 1 / 1 / 1 / 1.5\* | 0.5 / 1\* | 1.25 / 1.75 | 1 |
| Sucrose \(60 / 70\) | 0 | 0.75\* | 1.25\* | 1.25\* |
| Traveler \(Anemo\) \(50 / 60\) | 1.75\* | 1.25\* | 1.75 / More Than 2\* | 0.5 |
| Traveler \(Geo\) \(50/60\) | 1.75\* | 1.25\* | 1 / \(Explosion\) More Than 2\* | More Than 2\* |
| Venti \(80\) | 0 | \(Body\) 0 / \(Weakpoint\) 0.5\* | 1.25\* | 0.25 |
| Xiangling \(80\) | 1.5\* | 0.5\* | 0.25 | 1.25 / \(Pyronado\) 0.125 |
| Xingqiu \(60/70\) | More Than 2\* | 1.25\* | 1.25 | More Than 2\* / 0.5 |
| Xinyan \(60/70\) | 0.75 / 0.75 / 0.75 / 1.25\* | 0.5 / 1 | 1.75\* | More Than 2\* / More Than 0.75 |
...
| Blazing Axe Mitachurl | Enhancing Axe | 5.75 |
...
_Total Poise Damage = Sum of Current Poise Damage - \(Time \* Poise Regen\)_
