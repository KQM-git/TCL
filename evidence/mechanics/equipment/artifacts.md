...
**Evidence:** Clip 1 was tested against the 3 same hilichurls using the same rotation and setup with Lisa + Venti (with ZL for shielding + res shred. https://youtu.be/bZOAH38YLMs
...
**Significance:** Viridescent Venerer continues to be a powerful set for Anemo supports. On 06/21/2021, the wiki stated that VV’s resistance reduction only affects the enemy hit by the Swirl reaction, but as I finished recording counterproof it had been changed, proving my findings.
