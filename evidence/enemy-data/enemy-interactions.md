...
### Fischl C1 Bug/Interaction with Ruin Sentinels

**By:** Laevatienn#7757  
**Added:** 08/17/2021  
[Discussion](https://tickettool.xyz/direct?url=https://cdn.discordapp.com/attachments/869852579834761246/877102436349775872/transcript-fischl-c1-bug-with-ruin-sentinels.html)

**Finding:**  
Ruin Sentinel enemies do not consistently proc Fischl's C1 or Oz's C6 extra attack. The type of Sentinel seems to affect how often C1 or C6 activate.  

Tests have various results. C1 is fairly consistent with how it behaves and how often it procs against a particular Sentinel types, ranging from not often to nearly 100% proc rate. C6 is more volatile in behavior. It sometimes appears to work 100% of the time but changes and only works some of the time. 

Both the C1 and C6 animation do occur as normal, with every auto attack. It is just the damage that does not seem to register. I initially thought this may be due to the enemy's hitbox not matching up with the enemy's hitbox, blocking the damage by intercepting the projectiles. This is easily disproven by stunning and enemy and noting how, despite being in the same position (Fischl C1 or Oz C6), the damage ticks are not consistent. More detailed notes of each enemy type are below. 

***Ruin Scout:***  
**C1:** Inconsistent activation of C1. More noticeable when attacking slower but seems to activate more reliably when shooting normally.  I had about 60%  (roughly) chance to activate C1. Hitting weak point and stunning the enemy had no effect on C1 activation. Note, sometimes the C1 hit was delayed compared to normally C1 procs and may result in weird statistics.  
**C6:** Ruin Scouts are hit most of the time. However, there are points when it does not seem to hit them as well. These results varied greatly between different targets/attempts.

***Ruin Defender:***  
**C1:** Very low chance of C1 activating. Basically near 0 when the enemy is not stunned. I had one or two procs of C1 against three total enemies. When stunned, chances seem to go up slightly. I had a few extra procs only when stunned and only when shooting normally. Failed to activate at all when shooting slowly.  
**C6:** Ruin Defenders are hit more often with C6 than C1 but there are times when the the bolt animation hits but no damage is listed. 

***Ruin Cruisers:***  
**C1:** No procs against roughly 9 sample targets regardless of if the enemy was stunned or not. May be similar to Ruin Guardian in that it is just a very low chance.  
**C6:** There are a few damage procs of C6 here and there however most of the projectiles that "hit" did not cause perceivable damage ticks. 
...
**Evidence:**  
C1 behavior video can be found here: [Video](https://youtu.be/lW0vmdUAh9o)  
C6 behavior video can be found here: [Video](https://youtu.be/1iw_c2JFg2U)  

**Significance:**  
Fischl is not ideal against the Ruin Sentinels.
