---
description: A diminutive Witch Hunter who has journeyed all the way from Nod-Krai with the singular purpose of rooting out a witch who, to hear her tell it, has committed every sin imaginable — including bullying little kids!
---

import char from '@site/src/data/characters/Prune.json'
...
<Image img={require('/img/characters/gacha/Prune.png')} alt="Prune's gacha art" />
...
<!-- 
* [Prune Mains Discord]()
* [Full Prune Written Guide]()
* [Prune Quick Guide]()
* [# Minute Video Guide to Prune]()
-->
...
<!-- 
import charFrames from '@site/src/data/frames/Prune.json'
...
<Card item={require('../../evidence/characters/anemo/prune.md')} />
