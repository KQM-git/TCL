...
import char from '@site/src/data/characters/Nicole.json'
...
<Image img={require('/img/characters/gacha/Nicole.png')} alt="Nicole's gacha art" />
<blockquote>{frontMatter.description}</blockquote>

## Resources

<!-- 
* [Nicole Mains Discord]()
* [Full Nicole Written Guide]()
* [Nicole Quick Guide]()
* [# Minute Video Guide to Nicole]()
-->
...
<!-- 
import charFrames from '@site/src/data/frames/Nicole.json'
...
<Card item={require('../../evidence/characters/pyro/nicole.md')} />
