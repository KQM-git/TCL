---
description: Naturalist and Advisor to the Nod-Krai Branch of the Adventurers' Guild.
---

import char from '@site/src/data/characters/Linnea.json'
...
<Image img={require('/img/characters/gacha/Linnea.png')} alt="Linnea's gacha art" />
<blockquote>{frontMatter.description}</blockquote>

## Resources

<!-- 
* [Linnea Mains Discord]()
* [Full Linnea Written Guide]()
* [Linnea Quick Guide]()
* [# Minute Video Guide to Linnea]()
-->
...
<!-- 
import charFrames from '@site/src/data/frames/Linnea.json'
...
<Card item={require('../../evidence/characters/geo/linnea.md')} />
