...
* Electro-charged \(Electro-Charged\) is unique because both Hydro and Electro simultaneously function as both auras and triggers. In addition, both auras can co-exist on an enemy.
...
* Electro-Charged will continue to tick at an interval of once per second as long as sufficient Electro and Hydro gauge remains except in the following cases
...
* As a result, Electro-Charged is the only elemental reaction gated by an internal cooldown \(ICD\).
...
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_845683620832084008_855002512116416512_transcript-Freezee-test-hunt.html)
...
2. The Freezee triggered should last for `2sqrt(5x2x0.8x8x(1-0.5/(2.5x8+7))+4)-4=12.348s`.
...
4. The ~12.56gu Freezee aura can survive the 8gu Freezee consumption from shatter.
