...
* [clip 3 and 4:](https://youtu.be/wqxnXhkMuNg) in both cases, the enemy is first hit by 4u from beidou.
  * Then, in clip 3, Gouba is summoned, who then attacks within 3 frames of klee who autoattacks. 2 overload numbers appear.
  * In clip 4, Gouba is not summoned, and klee just n1cs. 1 overload number.
...
* Electro-Charged damage ticks once per second starting from the initial reaction. In other words, Electro-Charged has a **CD of 1 second** and can **only damage an enemy once per second.** Multiple ECs on one enemy cannot exist.
...
* For example,
  * 0.0s: Electrocharged is triggered.
    ...
    * Electro aura = 7s left
* If we go according to the above finding, we would expect there to be a second “early” Electro-Charged tick. However, this is not the case.
...
* 0f: Electro-Charged triggered \(but damage hasn’t gone through yet\)
...
### Electro-Charged + Heavy Hits Stagger Lock
...
Applying Electro-Charged \(Electro-Charged\) and dealing heavy hits \(HH\) on Ruin Guards appears to reduce the Ruin Guard's stun resistance. This will eventually allow the Ruin Guard to be stun locked without weak point hits. Stun will continue until Electro-Charged and HH application expires.
...
4. Electro-Charged application expires
...
The amount of Electro gauge should therefore not be enough to support 4 ticks of Electro-Charged. Thus, this is either a bug, or Electro-Charged has additional mechanics that we are unaware of. This finding is similar to [How Hitlag affects Electro-Charged](./transformative-reactions.md#how-hitlag-affects-Electro-Charged). Though, it notably shows that the bug may be based both on hitlag as well as another factor, as one of the triple Electro-Charged ticks (still strange) is done without hitlag (Lisa and orbitals and melody loop).
...
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_887433546665447454_890108328393465876_transcript-Electro-Charged-ticks-ignore-hitlag.html)
...
[Video](https://youtu.be/Zj_dfxLKnB4): Electro-Charged Tick timing with no hitlag  
1288 (1st tick's damage text is always late to appear)  
1343  
1404  
1465

[Video](https://youtu.be/qaJuHyAUZcU): Electro-Charged Tick timing with 3 Beidou Normal's hitlag  
1518  
1572  
1633  
1695

[Video](https://youtu.be/dgexv45RicM): Electro-Charged Tick timing with Xiangling hitlag, for maximum hitlag  
1152  
1209  
1269  
1329  
...
This seems like an extension of the TCL finding that Deployables' attack speed, duration etc are not affected by hitlag. Electro-Charged is not caused directly by your character, it's almost like a deployable damage source attached to the enemy, so it appears to follow similar rules.

**Significance:**  
You can extend the duration of auras involved in Electro-Charged by using hitlag. This also technically improves the DPS of Electro-Charged comps very slightly, as even if your character's DPS slows down slightly due to hitlag, Electro-Charged continues to damage the enemy at the same rate.  
...
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_896132765072900146_899187533542481971_transcript-Electro-Charged-snapshots-em-until-re-apply.html)
...
1. Electro-Charged damage when EM changes. No re-applying from characters.
2. Electro-Charged damage when EM changes. Same source re-applying.
3. Electro-Charged damage when a different source re-applies an Element.
4. Electro-Charged damage when a source re-applies then changes EM without re-applying.
...
5) Electro-Charged damage when a source re-applies then changes EM then re-applies.  
...
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_918000788373123172_919129870959783996_transcript-Electro-Charged-icd.html)

**Finding:**

* Electro-Charged has a cooldown. An enemy can only take one instance of Electro-Charged damage in ~0.5s.
* Electro-Charged AoE ticks count as Electro-Charged damage, thus a tick will start Electro-Charged icd and deal no damage if it lands when the cooldown is active.
* Electro-Charged AoE ticks reset damage cooldown and restart 1s timer for the next Electro-Charged tick (as long as auras don't run out).
  * These two together will cause a cascading effect of syncing up Electro-Charged ticks.

**Evidence:**

* [Electro-Charged ICD](https://youtu.be/rW16nK1-UhI)
* [Electro-Charged icd not here, around 0.5s](https://youtu.be/6ElYkAYvf9E)
...
### Electro-Charged AoE Changes Ownership on Other Electro-Charged'd Enemies

**By:** NZPIEFACE\#8439  
**Added:** <Version date="2021-12-16" />  
**Last tested:** <VersionHl date="2021-12-16" />  
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_917973191782187049_919138790193393664_transcript-Electro-Charged-aoe-changes-ownership-of-other-Electro-Charged-enemies.html)

**Finding:**  
Electro-Charged AoE ticks change ownership on other Electro-Charged'd enemies.
...
### Electro-Charged Ticks Are Neither Reactions Nor Hits

**By:** NZPIEFACE\#8439  
**Added:** <Version date="2021-12-27" />  
**Last tested:** <VersionHl date="2021-12-27" />  
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_923417727538954250_924789849364516924_transcript-Electro-Charged-ticks-are-neither-reactions-nor-hits.html)
...
### Electro-Charged Ticks Only Consume Hydro and Electro Gauge When Both are Present

**By:** NZPIEFACE\#8439  
**Added:** <Version date="2022-01-03" />  
**Last tested:** <VersionHl date="2022-01-03" />  
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_926980059363934238_927610678628470854_transcript-Electro-Charged-ticks-only-consume-gauge-when-hydro-and-electro-are-present.html)
...
### Electro-Charged Ticks Only Consume Gauge When They Deal Damage

**By:** NZPIEFACE\#8439  
**Added:** <Version date="2022-01-03" />  
**Last tested:** <VersionHl date="2022-01-03" />  
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_926982108273061928_927610723226517584_transcript-Electro-Charged-ticks-consume-gauge-when-they-deal-damage.html)
...
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_923420389915381770_929316314999320576_transcript-zero-gauge-attacks-dont-change-Electro-Charged-ownership.html)
...
### Electro-Charged Hydro aura Electro Trigger Interaction is Bugged

**By:** D.....K\#9002  
**Added:** <Version date="2022-03-09" />  
**Last tested:** <VersionHl date="2022-03-09" />  
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_945097851195777054_951298348135116901_transcript-Electro-Charged-hydro-aura-electro-trigger-interaction-is-bugged.html)
...
### Electro-Charged on Electro-Charged Mechanics

**By:** Mutsuki\#0884  
**Added:** <Version date="2022-03-22" />  
**Last tested:** <VersionHl date="2022-03-22" />  
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_945097851195777054_956006164041170974_transcript-Electro-Charged-on-Electro-Charged-mechanics.html)
...
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_843689180998402048_852779789747355688_transcript-simultaneous-hydro-on-Freezee.html)
...
**Theory:**  
Blunt attacks have no ICD, meaning they will always trigger shatter. This makes it suboptimal to run Freezee with any character whose attacks have the "blunt" attribute.
...
**_Note:_** The Freezee table is now found to be inaccurate. Refer to the [Evidence Vault](./transformative-reactions.md#Electro-Charged-Frozen-double-reactions) for more infomation.
...
**Added:** <Version date="2021-08-09" />  
**Last tested:** <VersionHl date="2021-08-09" />  
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_858306167686823956_874079173520527360_transcript-Freezee-duration-formula-theory-hunt.html)
...
**Significance:**
The formula to find Freezee duration is accurate to 0.1s or 6 frames in 60 fps for both Cryo/Hydro and both Swirled auras. However it seems Freezee duration is also affected by hitlag. Additionally ,It is unknown how Mona's c1 affects Freezee duration for now.
...
**Finding:**  
The order of elemental application and the gauge units determines the second reaction that occurs (and whether it occurs) when the attack that reacts with Freezee can cause both shatter and a different reaction.
...
**Significance:** Allows for better (but still incomplete) understanding of when double reactions can be utilized and how to set them up. Additionally, both the previous [Freezee table](./transformative-reactions.md#Freezee-aura-mechanics) and the [Electro-Charged interactions with other elements ticket](./transformative-reactions.md#interaction-of-other-elements-with-Electro-Charged-targets) are found to be inaccurate.
...
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_881008110699937792_939917731388600362_transcript-Freezee-extensions.html)

**Finding:**  
The duration of repeated Freezees can be described by the following formulae:
...
The Freezee duration in seconds is equal to the second formula. The value d_frozen is in elemental durability and is equal to twice the minimum of the Cryo or Hydro gauge when Freezee is triggered.
...
And then solving for t (generic solution to quadratic equation). This was done in a previous ticket. [TicketTool](https://tickets.deeznuts.moe/ticket-archive/attachments_866091819946344458_901006429228498964_transcript-Freezee-extension.html)
...
Github: [Github](https://github.com/ellimiku/Freezee_extension_analysis)  
Write-up: [Google Docs](https://docs.google.com/document/d/1JJTGJzIUdIKUCEK-SxWECSyWcBmMK3tzLnjmkVimzys/edit#)

**Significance:**  
Better understanding of Freezee duration. More accurate dps calcs in permafreeze teams. Gcsim.
...
* [4-Piece Instructor](https://youtu.be/9bGdyhvrBYY)
...
**Finding:**  
The [Frozen formula](#duration-of-Freezee-aura) does work for innate aura enemies.
...
A future test of 1U Freeze, 2U Hydro, 2U Anemo is technically necessary to say for certain that the Anemo reduction must be greater than the Hydro aura in Freeze/Hydro, rather than any one of the gauges present. However, Electro-Charged works this way and there is no known current method to test the above, so the behavior is currently believed to extend to Freeze/Hydro.

_If the Anemo gauge reduction isn't greater, the Swirl will be Electro\(Electro-Charged\)/Hydro\(Freeze\)_
...
**Added:** <Version date="2022-03-16" />  
**Last tested:** <VersionHl date="2022-03-16" />  
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_945097851195777054_953822978754363472_transcript-confirmation-of-double-Swirl-on-Freezee-aura-mechanics.html)
...
[Discussion](https://tickets.deeznuts.moe/ticket-archive/attachments_833831469373718568_834244407888314438_transcript-venti-and-sucrose-Burst-will-infuse-hydro-against-Electro-Charged-enemies.html)
...
[Electro-Charged Absorption Test Sucrose - Hydro applied first](https://www.youtube.com/watch?v=tmv_IU2PqBQ)  
[Electro-Charged Absorption Test Sucrose- Electro applied first](https://www.youtube.com/watch?v=TyPnCWmd-08)  
[Electro-Charged Absorption Test - Venti Burst](https://www.youtube.com/watch?v=q-Ep7_JsNfs)
...
Notice the hilichurl takes no burning dmg but still burns any grass it stepped on. The icon on his head is a burning aura (very much like a Freezeing aura of Freezee reaction). (This video is my experiment about the impact of EM on burning dmg, but it unexpected turn out like that). Only this kind of hilichurl have this odd ability was sighted so far.
