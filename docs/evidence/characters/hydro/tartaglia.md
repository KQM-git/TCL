...
**Finding:**  
Childe can forward Vaporize both his melee Burst, and Riptide Blast given enough Pyro support. This Pyro support can come in the form of as little as Xiangling Burst + Guoba, although due to Guoba’s lack of range, lack of braincells and ability to be knocked away, another Pyro support is recommended (such as Pyro-infused Sucrose).
