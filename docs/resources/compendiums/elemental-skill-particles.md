...
| Raiden                    | Skill itself produces no Particles, every type of damage \(including non-Electro-Charged reaction triggered by skill\) triggers coordinated attack, which produce Particle \(0~1 \(1:1\) check, 0.9s icd, does not buffer\), doesn't have to stay on field | 0.9            | 0~1 \(1:1\)         | 0.50              | 33.3          |
| Razor                     |                                                                                                                                                                                                                                               | 6              | 3 \(-\)             | 3.00              | 30.0          |
