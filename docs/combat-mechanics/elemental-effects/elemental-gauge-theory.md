...
Electro-charged \(Electro-Charged\) is unique to all previously covered reactions. The current theory is that in Electro-Charged, both Hydro and Electro simultaneously function and coexist as both the aura and trigger.

Electro-Charged is triggered when an enemy with a Hydro or Electro aura has the other aura applied to it. Electro-Charged will tick once per second so long as enough Electro and Hydro gauge remain, except in the following case:
