...
* There is a bug that causes your character to [stop moving while sprinting](../../evidence/mechanics/gameplay-mechanics/bugs.md#sprinting-bug), while still consuming stamina.
